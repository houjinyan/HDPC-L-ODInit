...
import torch
from torch_geometric_temporal.nn.recurrent import GCN
...
class TemporalGNN(torch.nn.Module):
    def __init__(self, adj, hidden_dim, time_len,pre_len):
        ...
        self.tgnn = GCN(adj, time_len, hidden_dim)
...
df_train.to_csv('GCN_Train_Log_'+str(EPOCH)+'epoch_' + str(WEIGHTED) + '.csv')
df_test.to_csv('GCN_Test_Log_'+str(EPOCH)+'epoch_' + str(WEIGHTED) + '.csv')