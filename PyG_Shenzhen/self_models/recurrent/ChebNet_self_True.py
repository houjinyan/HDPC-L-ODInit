...
import torch
from torch_geometric_temporal.nn.recurrent import ChebNet
...
class TemporalGNN(torch.nn.Module):
    def __init__(self, adj, hidden_dim, time_len,pre_len):
        ...
        self.tgnn = ChebNet(time_len, hidden_dim*2,hidden_dim)
...
df_train.to_csv('ChebNet_Train_Log_'+str(EPOCH)+'epoch_' + str(WEIGHTED) + '.csv')
df_test.to_csv('ChebNet_Test_Log_'+str(EPOCH)+'epoch_' + str(WEIGHTED) + '.csv')