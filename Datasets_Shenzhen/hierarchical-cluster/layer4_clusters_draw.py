...
if __name__ == "__main__":
    clusters_datas_final=pd.read_csv("../cluster_layers/layer4_cluster_datas_final_exSea.csv")
    ...
    for k in range(clusters_orders_num):
        clusters_datas_k = clusters_datas_final[
            clusters_datas_final['cluster_order_final'] == clusters_orders[k]].reset_index()
        plt.scatter(clusters_datas_k['center_final_lng'], clusters_datas_k['center_final_lat'], color="k", marker=".", s=5.)
    plt.savefig('../cluster_layers/layer4_clusters_final.jpg')