...
if __name__== "__main__":
    ...
    clusters = pd.read_csv('../cluster_layers/layer' + str(layer) + '_cluster_datas_final_exSea.csv')
    clusters_orders = sorted(clusters['cluster_order_final'].unique().tolist())
    print(len(clusters_orders))
    with open('layer'+str(layer)+'_clusters_final_exSea.csv','w') as fin:
