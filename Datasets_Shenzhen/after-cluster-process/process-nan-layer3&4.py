...
layer2_m_in=np.array(pd.read_csv(file_name_layer2_m_in,header=0,index_col=0))
...
layer3_m_in=np.array(pd.read_csv(file_name_layer3_m_in,header=0,index_col=0))
...
layer1_m_out=np.array(pd.read_csv(file_name_layer1_m_out,header=0,index_col=0))
...
layer2_m_out=np.array(pd.read_csv(file_name_layer2_m_out,header=0,index_col=0))
...
layer3_m_out=np.array(pd.read_csv(file_name_layer3_m_out,header=0,index_col=0))
...
pd.DataFrame(layer1_m_out).to_csv("out_weighted\layer1_dataset_m.csv")
...
pd.DataFrame(layer2_m_out).to_csv("out_weighted\layer2_dataset_m.csv")
...
pd.DataFrame(layer3_m_out).to_csv("out\layer3_dataset_m.csv")
pd.DataFrame(layer3_l_out).to_csv("out\layer3_dataset_l.csv")
pd.DataFrame(layer4_s_out).to_csv("out\layer4_dataset_s.csv")
pd.DataFrame(layer4_m_out).to_csv("out\layer4_dataset_m.csv")
...
pd.DataFrame(layer3_m_out).to_csv("out_weighted\layer3_dataset_m.csv")
...
pd.DataFrame(layer4_m_out).to_csv("out_weighted\layer4_dataset_m.csv")
