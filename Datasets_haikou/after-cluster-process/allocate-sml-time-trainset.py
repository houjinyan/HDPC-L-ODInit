...
if __name__== "__main__":
    testset_datas=pd.read_csv('../trainset/shenzhen_trainset_final.csv')
    datas_num=testset_datas.shape[0]

    with open('../after-cluster-process/trainset/sml_time_trainset_datas.csv','w') as fin:
    ...
    for i in range(datas_num):
        ...
        with open('../after-cluster-process/trainset/sml_time_trainset_datas.csv','a') as fin:
