...
if __name__== "__main__":
    testset_datas=pd.read_csv('../valiset/shenzhen_valiset_final.csv')
    datas_num=testset_datas.shape[0]

    with open('../after-cluster-process/valiset/sml_time_valiset_datas.csv','w') as fin:
    ...
    for i in range(datas_num):
        ...
        with open('../after-cluster-process/valiset/sml_time_valiset_datas.csv','a') as fin:
