...
def model_supervisor(args,start_time):
    init_seed(args.seed)
    ...
    dataloader = get_dataloader(
        ...
        io=args.IO,
        isweighted=args.isweighted
    )
    graph = load_graph(args.graph_file).to(args.device)
...
if __name__=='__main__':
    ...
    with open(args.dataset+"_"+args.IO+"_"+args.isweighted+"_train.csv",'w') as f:
        f.write('epoch,accuracy,rmse,R2,E-V,time\n')
    with open(args.dataset+"_"+args.IO+"_"+args.isweighted+"_val.csv",'w') as f:
        f.write('epoch,accuracy,rmse,R2,E-V,time\n')
    model_supervisor(args,start_time)